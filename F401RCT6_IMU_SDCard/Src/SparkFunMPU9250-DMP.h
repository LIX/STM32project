...
public:
	...
	// Output: INV_SUCCESS (0) on success, otherwise error
	inv_error_t enableInterrupt(unsigned char );
	...
	// Output: INV_SUCCESS (0) on success, otherwise error
	inv_error_t dmpBegin(unsigned short  , unsigned short  );
	...
	// Output: INV_SUCCESS (0) on success, otherwise error
	inv_error_t dmpSetTap(unsigned short , 
	                      unsigned short , 
	                      unsigned short ,
						  unsigned char , 
						  unsigned short ,
	...
	// Output: INV_SUCCESS (0) on success, otherwise error
	inv_error_t dmpSetOrientation(const signed char * );
